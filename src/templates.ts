  ...
  regression:
    ...
    steps:
      ...
      - name: Run regression suite
        ...
        run: crucible run --config .claude --suite crucible --junit crucible-results.xml --markdown "$GITHUB_STEP_SUMMARY"
        # Tip: add --concurrency 4 to run trials in parallel (raises peak token cost)
